...
export const ROLES = ["student", "parent", "staff", "instructor", "teacher", "administrator"] as const;

/** Roles that can access the staff portal (messages, parent calls). */
export const STAFF_PORTAL_ROLES = ["staff", "instructor", "teacher", "administrator"] as const;

/** Academy tutors — student assignments, parent messaging (not the school teacher planner). */
export const TUTOR_PORTAL_ROLES = ["instructor", "administrator"] as const;

/** School teachers — digital planner workspace; messaging scoped to their registered school. */
export const TEACHER_PORTAL_ROLES = ["teacher", "administrator"] as const;
