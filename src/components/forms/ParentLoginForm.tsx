    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="rounded-lg bg-explore-teal/10 border border-explore-teal/20 p-4 mb-6">
        <p className="text-sm text-explore-charcoal/80">
          <strong>Parent Portal Access</strong> - Sign in with your parent account credentials.
        </p>
      </div>
      ...
      <p className="text-center text-sm text-explore-charcoal/60">
        ...
        <Link href={`/parent/signup?callbackUrl=${encodeURIComponent(callbackUrl)}`} className="text-explore-teal font-medium hover:underline">
      ...
      <p className="text-center text-sm text-explore-charcoal/50">
        Are you a student?{" "}
        <Link href="/student/login" className="text-explore-teal font-medium hover:underline">
          Student Login
        </Link>
      </p>
    </form>
